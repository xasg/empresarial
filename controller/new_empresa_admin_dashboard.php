<?php
   ...
   crear_empresa_admin($id_user, $nombre);
...
**/
   ...
   ?>
<script>
   // window.location="../view/new_empresa_admin_dashboard.php?registrada"
   window.location="../dashboard/view/new_empresa_admin_dashboard.php?registrada"
</script>
<?php
}else{
