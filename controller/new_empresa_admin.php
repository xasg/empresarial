               ...
               <tbody>
                   <tr>
                       <td style="padding: 0; background-color: #ffffff;">
                           <div class="misection">
                               <h2 style="color: #0D4D5B; margin: 0 0 7px">Nuevo registro desde ADMIN a la plataforma EMPRESARIAL - FESE </h2>
                               ...
                               <ol style="text-align: justify;">
                                   ...
                                   <li><strong>Empresa:</strong> '.$empresa['dt_nombre_comercial'].'</li>
