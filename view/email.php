        ...
        foreach ($_REQUEST['correo'] as $key => $emailCliente) {
            ...
            <body>
                <div class="contenedor">
                    <img class="imgBanner" src="https://raw.githubusercontent.com/xasg/empresarial/dev-1/imgs/BANN.png" alt="">
                    <table style="max-width: 1400px; padding: 10px; margin:0 auto; border-collapse: collapse;">
                            ...
                            <tr>
                                <td style="padding: 0; background-color: #ffffff;">
                                    <div class="misection">
                                        ...
                                        <a href="http://empresarial.fese.mx/"  style="border-radius: 12px; box-shadow: 0 0 10px #000; background: #330867; color: #fff; padding: 20px; text-decoration: none; margin-top: 60px ;">Subir documentos</a>
                     ...
                     <tfoot>
                        <tr>
                            <td>
                                <div style="display:flex; align-items: center; justify-content: center; margin: 1px; flex-direction: column; width: 99%; background-image: url(https://raw.githubusercontent.com/xasg/empresarial/dev-1/img/Footer.png); height: 25vh; background-position: center; background-size: cover; background-repeat: no-repeat; text-align: center;">
                                    <h5 style="text-align: center; color: #fff; font-size: 18px; margin: 20px;">Siguenos en redes sociales</h5>
                                    <div style="display:flex; align-items: center; justify-content: center; margin:5px;">
                                        <a href="https://www.facebook.com/FESE.MX"><img style="height: 52px; width: 52px; margin: 10px;" src="https://raw.githubusercontent.com/xasg/empresarial/dev-1/img/FB-mail.png" alt=""></a>
                                        <a href="https://www.linkedin.com/company/fundacion-educacion-superior-empresa/?originalSubdomain=mx"><img style="height: 52px; width: 52px; margin: 10px;" src="https://raw.githubusercontent.com/xasg/empresarial/dev-1/img/LinkedINs.png" alt=""></a>
                                    </div>
                                </div>
                            </td>
                        </tr>
