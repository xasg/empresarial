...
<!-- Se utilizan estilos de carpeta externa al dashboard despues se aCOPLA TODO -->
...
<div class="row text-center mt-5 mb-5">
    <div class="col-12">
        <a href="invitar_vacante.php?vac=<?php echo $vacante ?>" class="btn btn-round btn-primary">Volver al Inicio</a>
    </div>
</div>
</div>
</body>
